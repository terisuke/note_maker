...
PORT="$PORT" LLM_BASE_URL="$LLM_BASE_URL" LLM_MODEL="$LLM_MODEL" STYLE_LLM_MODEL="$STYLE_LLM_MODEL" BRIEF_LLM_MODEL="$BRIEF_LLM_MODEL" ARTICLE_LLM_MODEL="$ARTICLE_LLM_MODEL" DRAFT_LLM_MODEL="$DRAFT_LLM_MODEL" VERIFY_LLM_MODEL="$VERIFY_LLM_MODEL" LLM_FALLBACK_BASE_URLS="$LLM_FALLBACK_BASE_URLS" STYLE_LLM_FALLBACK_MODELS="$STYLE_LLM_FALLBACK_MODELS" BRIEF_LLM_FALLBACK_MODELS="$BRIEF_LLM_FALLBACK_MODELS" ARTICLE_LLM_FALLBACK_MODELS="$ARTICLE_LLM_FALLBACK_MODELS" DRAFT_LLM_FALLBACK_MODELS="$DRAFT_LLM_FALLBACK_MODELS" VERIFY_LLM_FALLBACK_MODELS="$VERIFY_LLM_FALLBACK_MODELS" LLAMACPP_BASE_URL="$LLAMACPP_BASE_URL" LLAMACPP_MODEL="$LLAMACPP_MODEL" go run ./cmd/server &
APP_PID="$!"
