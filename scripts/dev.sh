...
PORT="$PORT" LLM_BASE_URL="$LLM_BASE_URL" LLM_MODEL="$LLM_MODEL" STYLE_LLM_MODEL="$STYLE_LLM_MODEL" BRIEF_LLM_MODEL="$BRIEF_LLM_MODEL" ARTICLE_LLM_MODEL="$ARTICLE_LLM_MODEL" DRAFT_LLM_MODEL="$DRAFT_LLM_MODEL" LLAMACPP_BASE_URL="$LLAMACPP_BASE_URL" LLAMACPP_MODEL="$LLAMACPP_MODEL" go run ./cmd/server &
APP_PID="$!"
